...
/** CONVERSION GPIO value from Hex value to TEMPERATURA*/
/** Yt(x)= 6.0694*x^2 -54.0728*x + 92.2345  */
//#define ADBMS6948_CONVERT_GPIO_HEX_TO_TEMPERATURA(x)  ( 6.0694*((float)(x) * 0.000150f + 1.5f)^2 - 54.0728*((float)(x) * 0.000150f + 1.5f) + 92.2345 )
//pow(2, 10)
//#define ADBMS6948_CONVERT_GPIO_HEX_TO_TEMPERATURA(x)  (  pow( ((float)(x) * 0.000150f + 1.5f),2 )    )
#define ADBMS6948_CONVERT_GPIO_HEX_TO_TEMPERATURA(x)  (   6.0694*((float)(x) * 0.000150f + 1.5f)*((float)(x) * 0.000150f + 1.5f)- 54.0728*((float)(x) * 0.000150f + 1.5f) + 92.2345 )
